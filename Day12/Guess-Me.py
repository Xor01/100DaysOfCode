...
# TODO 4: repeat TODO 3 until all attempts over :DONE

# TODO 5: print final result :DONE

# TODO 6: add logo and greeting statement :DONE
...
def check_value(user_guess, flag):
    """Returns 0 if user guess is equal to flag, -1 if it's less than flag, 1 if it's grater than flag """
    if user_guess == flag:
        return 0
...
def guess():
    ...
    game_level = input("What Difficulty level to play with 'easy' or' hard': ")
